    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (strFormId) 
        {
            ...
            case "2":
                ...
                //enmedio
                logic = new sugerenciasLogic(strConnString);
                ArrayList<sugerenciasObj> sugerArray = logic.getAllSuggests();
                
                //al final
                request.getSession().setAttribute("sugestarray", sugerArray);
                response.sendRedirect("sugerenciasList.jsp");
                break;
        }
    }
